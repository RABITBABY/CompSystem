...
var AwardListComponent = (function () {
    ...
    AwardListComponent.prototype.download = function (award) {
        this.http.get("http://localhost:8080/CompSystem/student/downloadAwards")
...
var StudentContestComponent = (function () {
    function StudentContestComponent(loginService, contestService) {
        this.loginService = loginService;
        this.contestService = contestService;
    }
    StudentContestComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.student = this.loginService.getUser();
        this.contestService.getStudentContests(this.student.studentno)
            .subscribe(function (contests) { return _this.appliedContests = contests; });
    };
